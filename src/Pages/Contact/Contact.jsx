    ...
    return (
        <div className='bg-amber-200'>
            <div class="lg:mx-40 py-5 roboto-slab text-white">
                ...
                <div class="hero bg-black p-5 rounded-2xl">
                    <div class="hero-content flex gap-10 flex-col lg:flex-row">
                        <div class="grid flex-2 grid-cols-1 lg:grid-cols-2">
                            <div class="text-center lg:text-left flex-1">
                                <div
                                    class="lg:p-10 space-y-5 text-black bg-gradient-to-r from-slate-500 to-slate-900 p-10 bg-transparent border-b-2 border-r-2 border-black outline-none">
                                    <div className='flex justify-center'>
                                        <FaLocationDot size={25} />
                                    </div>
                                    <h3 class="font-bold text-2xl text-center text-black cursor-pointer">
                                        Location</h3>
                                    <p class="text-white text-center">pA108 Adam Street,
                                        New York, NY 535022</p>
                                </div>
                            </div>
                            <div class="text-center text-black lg:text-left flex-1">
                                <div class="bg-blue-300 lg:p-10 space-y-5">
                                    <div className='flex justify-center'>
                                        <FaPhoneVolume size={25} />
                                    </div>
                                    <h3 class="font-bold text-2xl text-black cursor-pointer text-center">
                                        Phone</h3>
                                    <p class="text-white text-center">pA108 Adam Street,
                                        New York, NY 535022</p>
                                </div>
                ...
                bg-gradient-to-r from-slate-900 to-slate-500 p-10 bg-transparent border-l-2 border-black outline-none">
                        ...
                        <div class="flex-1 card bg-gradient-to-r from-indigo-500 via-purple-300 to-pink-400 lg:w-[500px] text-white  shrink-0 shadow-2xl">
